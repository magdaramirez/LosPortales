        ...
        when(option){
            "Antojitos"->{
                menu.add(Product("Quesadillas",
                    ...
                    "Rellenas de su carne favorita, servidas con ensalada. Filled with your choice of meat, served with salad.",
                    5.99))
                ...
                menu.add(Product("Coctel Mixto",
                    ...
                    "",
                    21.99))
                menu.add(Product("Coctel de Camarón",
                    R.drawable.coctel,
                    "",
                    16.49))
            }
            ...
            "Combinations"->{
                ...
                menu.add(Product("Mexican Burritos",
                    ...
                    12.99))
                menu.add(Product("Los Portales Burritos",
            ...
            "Tortas"->{
                menu.add(Product("Torta Regular",
                    ...
                    12.99))
                menu.add(Product("Torta - Milanesa de Res o de Pollo",
